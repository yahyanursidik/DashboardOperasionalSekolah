        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-card p-6 rounded-xl border shadow-sm">
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="text-sm font-medium flex items-center gap-2">Filter Kelas (Opsional)</label>
              <select
                value={classIdFilter}
            ...
            <div className="space-y-2">
              ...
              >
                <option value="">{queryResult?.isLoading ? "Memuat..." : "-- Pilih Siswa --"}</option>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                {visibility === 'internal' ? 'Catatan ini rahasia dan hanya untuk arsip sekolah.' : 'Catatan ini akan muncul di aplikasi orang tua sebagai laporan progres.'}
              </p>
            </div>
          </div>
        </div>
          ...
          {category !== 'stppa' && category !== 'anekdot' && (
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Contoh: Sudah dikomunikasikan dengan orang tua melalui WA."
          ...
          {category === 'stppa' && (
            <div className="mt-8 border rounded-xl overflow-hidden bg-muted/20">
              <div className="bg-indigo-50 border-b p-4">
                ...
                <p className="text-xs text-indigo-600/80 mt-1">Silakan pilih indikator tingkat pencapaian perkembangan anak (opsional per bidang).</p>
              </div>
