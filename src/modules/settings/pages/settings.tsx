...
export const SettingsPage: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"profile" | "users" | "appearance" | "security" | "finance">("profile");
      ...
      <div className="bg-card rounded-xl border shadow-sm overflow-hidden flex flex-col md:flex-row min-h-[500px]">
        ...
        <div className="md:w-64 border-b md:border-b-0 md:border-r bg-muted/10 shrink-0 p-4 space-y-1">
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors ${
              activeTab === "finance" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-muted/50 hover:text-foreground"
            }`}
          >
