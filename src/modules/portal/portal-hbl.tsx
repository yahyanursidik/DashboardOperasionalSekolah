...
import { PortalHblJourney } from "./portal-hbl-journey";

const hblDb = supabaseClient as any;
const preschoolLevelLabel: Record<string, string> = { kb: "KB · Kelompok Bermain", tka: "TK-A", tkb: "TK-B" };
...
export const PortalHbl: React.FC = () => {
  ...
  const load = useCallback(async () => {
    ...
    let enrollmentQuery = hblDb
      ...
      .select("program_id,hbl_programs!inner(id,name,description,status,preschool_level,semester_id,units(name),semesters(name,academic_years(name)))")
