...
export const PortalDashboard: React.FC = () => {
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      {/* Quick Alerts */}
      {unpaidInvoices > 0 && (
        <Link to="/portal/finance" className="block bg-red-50 border border-red-100 rounded-xl p-4 flex items-center gap-4 hover:bg-red-100 transition-colors">
      ...
      <div className="bg-white rounded-xl shadow-sm border p-5">
        ...
        <div className="grid grid-cols-4 gap-2">
          <div className="bg-gray-50 rounded-lg p-3 text-center">
            ...
            <div className="text-[10px] text-gray-500 font-medium uppercase tracking-wider mt-1">Hadir</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 text-center">
            <div className="text-xl font-bold text-amber-500">{attendance.sick}</div>
            <div className="text-[10px] text-gray-500 font-medium uppercase tracking-wider mt-1">Sakit</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 text-center">
            <div className="text-xl font-bold text-blue-500">{attendance.permission}</div>
            <div className="text-[10px] text-gray-500 font-medium uppercase tracking-wider mt-1">Izin</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 text-center">
            <div className="text-xl font-bold text-red-500">{attendance.absent}</div>
            <div className="text-[10px] text-gray-500 font-medium uppercase tracking-wider mt-1">Alpa</div>
          </div>
        </div>
      </div>
