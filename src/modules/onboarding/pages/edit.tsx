...
export const OnboardingEdit: React.FC = () => {
  ...
  useEffect(() => {
    if (queryResult?.data?.data) {
      ...
      setValue("material_type", record.material_type);
      setValue("file_url", record.file_url);
      setValue("status", record.status);
      setValue("order_index", record.order_index);
    }
  ...
  if (queryResult?.isLoading) {
    return <div className="p-12 text-center text-gray-500">Memuat data...</div>;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center text-sm text-gray-500 mb-2">
        ...
        <ChevronRight className="w-4 h-4 mx-1" />
        <span className="text-gray-900 font-medium">Edit Materi</span>
      </div>

      <PageHeader
        title="Edit Materi Onboarding"
        description="Perbarui informasi atau file materi yang sudah ada."
        action={
          <button
              ...
              <div className="bg-gray-50/50 p-5 rounded-xl border border-gray-200">
                {isFileBased ? (
                  <div className="space-y-4">
                    <label className="block text-sm font-semibold text-gray-700">Ganti File (Opsional)</label>
                    ...
                    >
                      ...
                      <p className="text-sm font-medium text-gray-700 mb-1">
                        {uploading ? 'Sedang mengunggah...' : 'Tarik dan lepas file di sini untuk mengganti'}
                      </p>
                      <p className="text-xs text-gray-500 mb-4">
                        atau klik tombol di bawah untuk memilih file baru
                      </p>
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-gray-500 mb-1">URL File Saat Ini</label>
                      <div className="relative">
                        <input
                          type="text"
                          {...register("file_url", { required: "File wajib ada" })}
                          readOnly
