...
import { AlertCircle, ArrowRight, CalendarClock, CheckCircle2, ClipboardCheck, ContactRound, FileClock, Loader2, Users } from "lucide-react";
...
export const AdmissionsDashboard: React.FC = () => {
  ...
  ]).then(([appResult, docResult, payResult, leadResult]) => { setApplicants(appResult.data || []); setDocuments(docResult.data || []); setPayments(payResult.data || []); setLeads(leadResult.data || []); setLoading(false); }); }, []);
