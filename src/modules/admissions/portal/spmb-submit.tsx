...
export const SpmbSubmit: React.FC = () => {
  ...
  const missingDocuments = requiredDocuments.filter((type) => !documents.some((document) => document.document_type === type.value && !["rejected", "revision_required"].includes(document.status)));
