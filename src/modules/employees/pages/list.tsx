...
const POSITION_MAP: Record<string, { label: string; color: string }> = {
  ...
  satpam:         { label: "Satpam",         color: "bg-orange-100 text-orange-800 border-orange-200" },
...
function EmployeeCard({ employee, onClick, onEdit }: { employee: any; onClick: () => void; onEdit: () => void }) {
