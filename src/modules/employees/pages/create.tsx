            ...
            <Field label="Jabatan Utama" required>
              <select
                ...
                onChange={(e) => {
                  ...
                  setPosition(value);
                  setAttendanceMode(getRecommendedAttendanceMode(value, employmentType));
                }}
                className={selectCls}
              >
            ...
            <Field label="Hubungan Kerja" required>
              <select
                ...
                onChange={(event) => {
                  ...
                  setAttendanceMode(getRecommendedAttendanceMode(position, value));
                }}
                className={selectCls}
              >
